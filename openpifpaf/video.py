...
Example commands:
    python3 -m openpifpaf.video --source=0  # default webcam
    python3 -m openpifpaf.video --source=1  # another webcam

    # streaming source
    python3 -m openpifpaf.video --source=http://127.0.0.1:8080/video

    # file system source (any valid OpenCV source)
    python3 -m openpifpaf.video --source=docs/coco/000000081988.jpg
