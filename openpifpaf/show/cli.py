...
def cli(parser):
    ...
    group.add_argument('--show', default=True, action='store_true',
    ...
    group.add_argument('--monocolor-connections', default=True, action='store_true',
                       help='use a single color per instance')
    group.add_argument('--line-width', default=2, type=int,
    ...
    group.add_argument('--show-box', default=False, action='store_true',  # 不是标注框好像是检测出来的
    ...
    group.add_argument('--show-joint-scales', default=True, action='store_true',
                       help='show boxes representing joint sizes')
    group.add_argument('--show-joint-confidences', default=True, action='store_true',
                       help='print per-joint confidences on skeleton annotations')
    group.add_argument('--show-decoding-order', default=True, action='store_true')
    group.add_argument('--show-frontier-order', default=True, action='store_true')
