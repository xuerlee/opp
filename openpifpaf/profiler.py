...
class TorchProfiler:
    ...
    def __call__(self, *args, **kwargs):
        ...
        # every time train_batch() is called, it will:
        # Profile the function’s execution using PyTorch’s profiler.
        # Print performance metrics such as CPU and GPU time (save the time in the output name?).
        # Save a Chrome trace of the profiling output.
