...
def cli():
    ...
    parser.add_argument('--dir_data', default='/home/xuer/daima/openpifpaf/openpifpaf-ini/data-apollocar3d/3d_car_instance_sample',
                        help='dataset directory')
    parser.add_argument('--dir_out', default='/home/xuer/daima/openpifpaf/openpifpaf-ini/data-apollocar3d/3d_car_instance_sample/annotation',
