...
class Wholebody(openpifpaf.datasets.DataModule):
    ...
    # cli configurable
    # train_annotations = ('/media/xuer/EAGET忆捷/数据集/COCO/annotations/person_keypoints_train2017_wholebody_pifpaf_style.json')
    # val_annotations = ('/media/xuer/EAGET忆捷/数据集/COCO/annotations/person_keypoints_val2017_wholebody_pifpaf_style.json')
    # train_image_dir = '/media/xuer/EAGET忆捷/数据集/COCO/train2017/'
    # val_image_dir = '/media/xuer/EAGET忆捷/数据集/COCO/val2017/'

    train_annotations = ('/home/travail/jiaqi/dataset/COCO/annotations/person_keypoints_train2017_wholebody_pifpaf_style.json')
    val_annotations = ('/home/travail/jiaqi/dataset/COCO/annotations/person_keypoints_val2017_wholebody_pifpaf_style.json')
    ...
    def _preprocess(self):
        encoders = (openpifpaf.encoder.Cif(self.head_metas[0], bmin=self.bmin),
                    openpifpaf.encoder.Caf(self.head_metas[1], bmin=self.bmin))  # 在datamodule中就有encoder
