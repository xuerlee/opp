...
from openpifpaf.plugins.robomaster.transforms import transform_skeleton
...
CAR_SKELETON_24 = transform_skeleton(SKELETON_ORIG, KPS_MAPPING)  # 返回每个关节点的id在原列表的位次

CAR_SIGMAS_24 = [0.05] * len(KPS_MAPPING)

split, error = divmod(len(CAR_KEYPOINTS_24), 4)  #　Return the tuple (x//y, x%y)
...
# =============================================================================
    with openpifpaf.show.Canvas.blank(nomargin=True) as ax_2D:
        ...
        anim_66.save('/home/xuer/daima/openpifpaf/opp/openpifpaf/plugins/robomaster/docs/CAR_66_Pose.gif', fps=30)
    with openpifpaf.show.Canvas.blank(nomargin=True) as ax_2D:
        anim_24 = plot3d_red(ax_2D, CAR_POSE_24, CAR_SKELETON_24)
        anim_24.save('/home/xuer/daima/openpifpaf/opp/openpifpaf/plugins/robomaster/docs/CAR_24_Pose.gif', fps=30)
