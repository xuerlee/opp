...
class CocoKp(openpifpaf.datasets.DataModule, openpifpaf.Configurable):
    ...
    # cli configurable
    train_annotations = '/media/jiqqi/EAGET忆捷/数据集/COCO/annotations/person_keypoints_train2017.json'
    val_annotations = '/media/jiqqi/EAGET忆捷/数据集/COCO/annotations/person_keypoints_val2017.json'
    # train_annotations = '/home/travail/jiaqi/dataset/COCO/annotations/person_keypoints_train2017.json'
    # val_annotations = '/home/travail/jiaqi/dataset/COCO/annotations/person_keypoints_val2017.json'
    ...
    def train_loader(self):
        train_data = CocoDataset(
            ...
            preprocess=self._preprocess(),  # 在这里直接把image ann加载到处理方法中（包括encoder）
