...
def cli():
    ...
    parser.add_argument('--checkpoints', default=["/home/travail/jiaqi/code/opp/openpifpaf/outputs_test/shufflenetv2k16-240831-011733-cocokp-cocodet.pkl.epoch273"], nargs='+',
