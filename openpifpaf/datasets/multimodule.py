...
class MultiDataModule(DataModule):
    ...
    def __init__(self, datamodules: List[DataModule]):
        ...
        self.head_metas = ConcatenatedLists([dm.head_metas for dm in datamodules])  # 拼接head_meta
    ...
    def train_loader(self):
        return MultiLoader([dm.train_loader() for dm in self.datamodules], len(self.head_metas))  # 拼接loader
